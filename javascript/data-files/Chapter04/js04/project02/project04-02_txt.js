...
function quoteGenerator() {
   ...
   // Generate a random integer to select a quote (fixed range)
   let randomQuote = randomInt(0, quoteCount - 1);

   // Retrieve a randomly selected quote (fixed variable name)
   let quote = quotes[randomQuote];

   // Display the random quote (fixed method and index)
