...
document.getElementById("square").onmouseover = function() {
   document.getElementById("feedback").textContent = "You're hovering over the square";
};
...
document.getElementById("triangle").onmouseover = function() {
   document.getElementById("feedback").textContent = "You're hovering over the triangle";
};
...
document.getElementById("circle").onmouseover = function() {
   document.getElementById("feedback").textContent = "You're hovering over the circle";
};
